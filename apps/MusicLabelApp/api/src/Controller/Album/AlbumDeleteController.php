...
use Masfernandez\MusicLabel\Infrastructure\Api\Controller\Album\InputRequest\AlbumDeleteInputData;
...
final class AlbumDeleteController extends AbstractController
{
    ...
    {
        $this->bus->dispatch(new DeleteAlbumCommand($inputData->getId()));
